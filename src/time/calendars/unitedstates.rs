...
impl UnitedStatesType {
    ...
    fn is_veterans_day_no_saturday(&self, date: &OffsetDateTime) -> bool {
        ...
        if y <= 1970 || y >= 1978 {
            ...
            (22..=28).contains(&d) && w == Weekday::Monday && m == Month::October
        }
    }
    ...
    fn goverment_bond_holiday(&self, date: &OffsetDateTime) -> bool {
        ...
        || ((15..=21).contains(&d) && w == Weekday::Monday && m == Month::January && y >= 1983)// Martin Luther King's birthday (third Monday in January)
    ...
    fn is_holiday(&self, date: &OffsetDateTime) -> bool {
        ...
        match self {
            ...
            UnitedStatesType::Nyse => {
                ...
                || (y == 2001 && m == Month::September && (11..=14).contains(&d)) // September 11-14, 2001
