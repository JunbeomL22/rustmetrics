...
mod tests {
    ...
    use rustmetrics::definitions::{DEFAULT_CLOSING_TIME, SEOUL_OFFSET};
    ...
    fn test_shared_evaluation_date() -> Result<()> {
        ...
        let zero_curve_data = VectorData::new(
            ...
            Currency::KRW,
            name.clone(),
            StaticId::from_str(name.as_str(), "DataProvider"),
        )
        ...
        let _zero_curve = ZeroCurve::new(
            ...
            &zero_curve_data,
            String::from("KRWGOV"),
            StaticId::from_str("zero curve".to_string().as_str(), "DataProvider"),
        )
        ...
        let _dividend = DiscreteRatioDividend::new(
            ...
            spot,
            "dividend".to_string(),
            StaticId::from_str("dividend".to_string().as_str(), "DataProvider"),
        )
